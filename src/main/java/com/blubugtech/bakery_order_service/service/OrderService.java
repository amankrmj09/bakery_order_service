...
import com.blubugtech.bakery_order_service.client.ProductServiceClient;
import com.blubugtech.bakery_order_service.client.InternalStatsClient;
...
import com.blubugtech.bakery_order_service.exception.*;
...
public class OrderService {
    ...
    public OrderResponseDto createOrder(OrderRequestDto request) {
        ...
        try {
            ...
            // Publish Kafka Event
            try {
                com.blubugtech.common.event.OrderEvent event = com.blubugtech.common.event.OrderEvent.builder()
